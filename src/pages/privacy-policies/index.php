                    ...
                    <div class="row justify-content-center mb-3">
                        <div class="col-12">
                            <div class="card rounded-0 p-5">
                                <div class="card-body">
                                    <p class="fw-bold mt-3">PLEASE READ THE PRIVACY POLICY CAREFULLY.</p>
                                    <p>Alltoscan.com (referred to as the “Company”, “Alltoscan”, “we”, “our” or “us”) is committed to the protection of your Personal Data and takes the matter of protecting your privacy as high priority.</p>
                                    
                                    <h6 class="fw-bold mt-5">1. TYPES OF DATA WE COLLECT</h6>
                                    <p>The types of Personal Data that we collect directly from you or from third parties depend on the circumstances of collection and on the nature of the service requested or transaction undertaken. It may include (but is not limited to):</p>
                    
                                    <p>(a) personal information that links back to an individual, e.g., name, gender, date of birth, and other personal identification numbers;<br/>
                                    ...
                                    <p>This Privacy Policy covers the information we collect about you when you use our products or services, or otherwise interact with Alltoscan, unless a different privacy policy is displayed. This policy also explains your choices about how we use information about you.</p>
                                    ...
                                    <h6 class="fw-bold mt-5">2. HOW DO WE COLLECT PERSONAL DATA?</h6>
                                    ...
                                    (c) under any other contractual agreement or arrangement.</p>
                                    ...
                                    (e) when we collect information about you from third parties; and other channels including our support helpdesk.</p>
                    
                    
                    
                                    <h6 class="fw-bold mt-5">3. HOW DO WE COLLECT YOUR PERSONAL DATA ON OUR WEBSITE?</h6>
                                    
                                    <p>From our website, we collect your Personal Data in the following ways:</p>
                    
                                    <p class="fw-bold">(a) IP address</p>
                                    <p>We use your IP address to help diagnose problems with our server, and to administer our website.</p>
                    
                                    <p class="fw-bold">(b) Cookies</p>
                                    <p>A cookie is an element of data that a website can send to your browser, which may then store it on your system. We use cookies in some of our pages to store your preferences and record session information.</p>
                                    ...
                                    <p>As cookies allow you to take advantage of some of the Website’s essential features, we recommend that you accept cookies. For instance, if you block or otherwise reject our cookies, you will not be able to use any products or services on the website that may require you to log-in (token holdings store cookies for favorite).</p>
                    
                                    <p>It is important that you prevent unauthorized access to your password and your computer. You should always log out after using a shared computer. Information collected from cookies is used by us to evaluate the effectiveness of our site, analyze trends, and manage the platform. The information collected from cookies allows us to determine such things as which parts of our site are most visited and difficulties our visitors may experience in accessing our site.</p>
                                    ...
                                    <p class="fw-bold">(c) User feedback form</p>
                                    ...
                                    <p class="fw-bold">(d) General Site tracking</p>
                                    <p>We also use third party service provider(s), to assist us in better understanding the use of our site. Our service provider(s) will place cookies on the hard drive of your computer and will receive information that we select, for example, how visitors navigate around our site, what pages are browsed and general transaction information. Our service provider(s) analyzes this information and provides us with aggregate reports.</p>
                                    ...
                                    <p class="fw-bold">(e) Web Server site visits logging</p>
                                    <p>The following is how we store the web server site visit logs (applicable to https://alltoscan.com/):</p>
                                    ...
                                    (iv) As part of our routine server maintenance, all raw web server site visit logs are retained for a minimum of 5 days only and then purged on an automated scheduled basis.</p>
                    
                    
                                    <h6 class="fw-bold mt-5">4.WHAT DO WE USE YOUR PERSONAL DATA FOR?</h6>
                                    ...
                                    (i) for all other purposes ancillary to any of the purposes stated above. ("Ancillary Purposes") (collectively, "Purposes")</p>
                    
                    
                                    <h6 class="fw-bold mt-5">5. ACCESSING / CORRECTING / UPDATING YOUR PERSONAL DATA</h6>
                                    ...
                                    <p>Please note that depending on the information requested, a nominal fee may be charged and/or backed by the Alltoscan signed message. We will endeavour to provide the information back to you as soon as practicable. However we also reserve the right to validate all requests for the authenticity of the request.</p>
                    
                    
                                    <h6 class="fw-bold mt-5">6. WITHDRAWING CONSENT</h6>
                                    <p>Please note that it is obligatory for the Company to process your Personal Data for the Core Purpose as stated above, without which some services or features provided by Alltoscan may be affected.</p>
                                    ...
                                    (c) sending a request via Contact Us.</p>
                    
                                    <h6 class="fw-bold mt-5">7. TO WHOM DO WE DISCLOSE YOUR PERSONAL DATA?</h6>
                                    ...
                                    <h6 class="fw-bold mt-5">8. HOW LONG WILL WE RETAIN YOUR PERSONAL DATA?</h6>
                                    ...
                                    <h6 class="fw-bold mt-5">9. LINKS TO THIRD PARTY WEBSITES</h6>
                                    ...
                                    <h6 class="fw-bold mt-5">10. ADDITIONAL INFORMATION OR ASSISTANCE</h6>
                                    ...
                                    <p>For further inquiries or complaints in relation to our handling of your Personal Data or our Privacy Policy or wish to access, update or amend your Personal Data as mentioned above please contact us via our feedback form at Contact Us.</p>
                                </div>
                            </div>
                        </div>
                    </div>
